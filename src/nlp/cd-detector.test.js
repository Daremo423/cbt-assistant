...
describe('detectCDs', () => {
  beforeEach(() => {
    ...
    // Explicitly set up the mock return value BEFORE requiring the module
    // This is critical because detectCDs calls loadModel() on initialization (if not test env, but here we invoke it via detectCDs)
    // Actually, detectCDs calls loadModel internally if model is null.

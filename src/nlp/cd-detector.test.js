...
describe('detectCDs', () => {
  ...
  beforeEach(() => {
    ...
    mockTensor.squeeze.mockImplementation(() => createMockSqueezedTensor(0.9));
  });
  ...
  test('should return an empty array if no cognitive distortions are detected', async () => {
    ...
    mockTensor.squeeze.mockImplementation(() => createMockSqueezedTensor(0.1));
  ...
  test('should detect "All-or-Nothing" distortion', async () => {
    ...
    mockTensor.squeeze.mockImplementation(() => createMockSqueezedTensor(0.95));

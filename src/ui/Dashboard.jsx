      ...
      >
        ...
        <DialogContent>
          <DialogContentText id="alert-dialog-description">
            This AI tool is for educational and self-help purposes only. It is not a substitute for professional mental health advice, diagnosis, or treatment.
            If you are experiencing a crisis or need help, please contact a professional immediately.
            By using this tool, you acknowledge that the insights provided are generated by AI and may not always be accurate.
          </DialogContentText>
        </DialogContent>
        <DialogActions>
          <Button onClick={handleAcknowledge} autoFocus variant="contained">
            I Acknowledge
          </Button>
        </DialogActions>
      </Dialog>

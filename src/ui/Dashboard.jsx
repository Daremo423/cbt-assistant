...
import { Container, Typography, TextField, Button, Grid, Card, CardContent, CircularProgress, Box, AppBar, Toolbar, IconButton } from '@mui/material';
      ...
      <AppBar position="static">
        <Toolbar>
          <Typography variant="h6" component="div" sx={{ flexGrow: 1 }}>
            CBT Assistant - {user ? user.username : 'Guest'}
          </Typography>
